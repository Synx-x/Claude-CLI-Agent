...
import { getSession, setSession, clearSession, getMemoryCount, createTask, listTasks, deleteTask, pauseTask, resumeTask } from './db.js';
...
export function createBot(): Bot {
  ...
  // Register commands in Telegram UI menu
